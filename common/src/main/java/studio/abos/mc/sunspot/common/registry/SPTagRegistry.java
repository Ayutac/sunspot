...
public interface SPTagRegistry {
    ...
    TagKey<Item> CHEST_BOATS = TagKey.create(Registries.ITEM, Sunspot.c("chest_boats"));
    TagKey<Item> SUBSTRATE_MATERIALS = TagKey.create(Registries.ITEM, Sunspot.id("substrate_materials"));
