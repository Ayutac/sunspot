...
public class SunspotFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        registerGlyphBlockTint(SPItemRegistry.LM_BATTERY);
        BlockEntityRendererRegistry.register(SPBlockEntityTypeRegistry.LM_BATTERY.get(), LmBatteryBlockEntityRenderer::new);
        registerGlyphBlockTint(SPItemRegistry.LM_BATTERY_CREATIVE);
        BlockEntityRendererRegistry.register(SPBlockEntityTypeRegistry.LM_BATTERY_CREATIVE.get(), LmBatteryCreativeBlockEntityRenderer::new);
